...
# En caso de cambiarlo, este será actualizado. De lo contrario, se mantendrá la imagen anterior
    ...
    return render(request, 'Cuentas/editarPerfil.html', { 'formulario_editar_perfil' : formulario_editar_perfil })
...
def cambiar_password(request):
    ...
    return render(request, 'Cuentas/cambiarContra.html', { 'formulario_cambio_password' : formulario_cambio_password })